...
namespace MicroCommerce.Identity.Admin.EntityFramework.Shared.DbContexts
{
    ...
    {
        public IdentityServerPersistedGrantDbContext(DbContextOptions<IdentityServerPersistedGrantDbContext> options, OperationalStoreOptions storeOptions) : base(options, storeOptions)
        {
        }
    }
}
