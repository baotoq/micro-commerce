...
namespace MicroCommerce.ApiService.Features.Coupons.Infrastructure.Migrations
{
    ...
    [Migration("20260308185447_InitialCoupons")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MicroCommerce.ApiService.Features.Coupons.Domain.Entities.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ValidFrom")
                        .HasDatabaseName("ix_coupons_valid_from");

                    b.HasIndex("ValidUntil")
                        .HasDatabaseName("ix_coupons_valid_until");

                    b.ToTable("coupons", "coupons");
                });

            modelBuilder.Entity("MicroCommerce.ApiService.Features.Coupons.Domain.Entities.CouponUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("coupon_usages", "coupons");
                });
            ...
            modelBuilder.Entity("MicroCommerce.ApiService.Features.Coupons.Domain.Entities.CouponUsage", b =>
                {
                    b.HasOne("MicroCommerce.ApiService.Features.Coupons.Domain.Entities.Coupon", null)
                        .WithMany()
