    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", maxLength: 100, nullable: false),
                    BuyerId = table.Column<Guid>(type: "uuid", maxLength: 100, nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    SubTotal = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalPromotionDiscountAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalCheckoutAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    DeliveryOptionId = table.Column<Guid>(type: "uuid", maxLength: 100, nullable: false),
