...
<task type="auto">
  ...
  <action>
    NOTE: This plan shares the test project created by Plan 01 (wave 1 parallel). If the test project doesn't exist yet, create it first using the same steps as Plan 01 Task 1. The dependency is on the test project .csproj only.
